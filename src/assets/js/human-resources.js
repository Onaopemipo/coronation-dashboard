        ...
        dropShadow: {
            ...
            plotOptions: {
             ...
             fill: {
                ...
                gradient: {
                    shade: 'light',
                    gradientToColors: ['#FF002B', '#FF002B', '#FF002B', '#FF002B', '#FF002B', '#FF002B', '#FF002B', '#FF002B', '#FF002B', '#FF002B'],
                    shadeIntensity: 1,
                    type: 'horizontal',
                    opacityFrom: 1,
                    opacityTo: 1,
            ...
            colors: ['#FF002B', '#FF002B', '#FF002B', '#FF002B', '#FF002B', '#FF002B', '#FF002B', '#FF002B', '#FF002B', '#FF002B'],
            dataLabels: {
                enabled: true,
                textAnchor: 'start',
                style: {
            ...
            xaxis: {
                categories: ['Esther Howard', 'Theresa Webb', 'Jerome Bell', 'Jacob Jones', 'Cameron Williamson', 'Wade Warren', 'Dianne Russell', 'T.co', 'Facebbok', 'LinkedIn'],
            },
            yaxis: {
                labels: {
                    show: false
...
var options = {
          ...
          sparkline:{
            ...
            fill: {
                ...
                gradient: {
                    shade: 'light',
                    gradientToColors: [ '#FF002B', '#FF002B'],
                    shadeIntensity: 1,
                    type: 'vertical',
                    opacityFrom: 1,
                    opacityTo: 1,
