...
export const Full_ROUTES: Routes = [
    ...
    {
      path: 'shareholder-analysis',
      loadChildren: () => import('../../shareholder-analysis/shareholder-analysis.module').then(m => m.ShareholderAnalysisModule)
    },
    ...
    {
      path: 'shareprice-analysis',
      loadChildren: () => import('../../shareprice-analysis/shareprice-analysis.module').then(m => m.SharepriceAnalysisModule)
    },
