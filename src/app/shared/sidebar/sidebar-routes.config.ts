...
//   {
//     path: '', title: 'Shareholder Analysis', icon: 'bx bx-category', class: 'sub', badge: '', badgeClass: '', isExternalLink: false,
//     submenu: [
...
// {
//   path: '', title: 'Industry Analysis', icon: 'bx bx-category', class: 'sub', badge: '', badgeClass: '', isExternalLink: false,
//   submenu: [
//       { path: '/application/email-app', title: 'Email', icon: 'bx bx-right-arrow-alt', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
//       { path: '/application/chat-box', title: 'Chat Box', icon: 'bx bx-right-arrow-alt', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
//       { path: '/application/file-manager', title: 'File Manager', icon: 'bx bx-right-arrow-alt', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
...
// },
    {
      path: '/shareholder-analysis', title: 'Shareholder Analysis', icon: 'bx bx-cart', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: []
    },
    { path: '/industry-analysis', title: 'Industry Analysis', icon: 'bx bx-cart', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: []},

    { path: '/shareprice-analysis', title: 'Share Price Analysis', icon: 'bx bx-cart', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: []},

    // { path: '/widgets', title: 'Industry Analysis', icon: 'bx bx-cookie', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: []},
    // {
